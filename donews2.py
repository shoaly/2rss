...
start = time.time()
rss = RSS(encode_code="utf-8",url="http://www.donews.com",rss_title=u"DoNews 完整版",output_file="donews_full.xml",tpl="tpl.py")
